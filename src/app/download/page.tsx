...
const versions: VersionInfo[] = [
  ...
  },
  {
    ...
    platforms: [
      ...
      { platform: "macOS (Apple Silicon) DMG", file: "ShopAgent-0.6.5-mac-arm64-2026-03-23.dmg", size: "199 MB", available: true },
      { platform: "macOS (Apple Silicon) ZIP", file: "ShopAgent-0.6.5-mac-arm64-2026-03-23.zip", size: "200 MB", available: true },
    ],
  },
  {
    version: "0.6.2",
    date: "2026-03-15",
    changelog: "性能优化与功能更新，支持 macOS",
    platforms: [
      { platform: "Windows x64", file: "ShopAgent-0.6.2-windows-x64-setup.exe", size: "311 MB", available: true },
      { platform: "macOS (Apple Silicon) DMG", file: "ShopAgent-0.6.2-mac-arm64-2026-03-15.dmg", size: "493 MB", available: true },
      { platform: "macOS (Apple Silicon) ZIP", file: "ShopAgent-0.6.2-mac-arm64-2026-03-15.zip", size: "226 MB", available: true },
    ],
  },
  {
    version: "0.6.1",
    date: "2026-03-14",
    changelog: "性能优化，稳定性提升",
    platforms: [
      { platform: "Windows x64", file: "ShopAgent-0.6.1-windows-x64-setup.exe", size: "311 MB", available: true },
